...
public class MyTitleBarBehavior2 extends CoordinatorLayout.Behavior<View> {
    public MyTitleBarBehavior2() {
        Log.d("ftd", "MyTitleBarBehavior()");
    }

    public MyTitleBarBehavior2(Context context, AttributeSet attrs) {
        super(context, attrs);
