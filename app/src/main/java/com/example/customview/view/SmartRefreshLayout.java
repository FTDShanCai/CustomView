    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        for (int i = 0, len = super.getChildCount(); i < len; i++) {
            ...
            if (mRefreshHeader != null && mRefreshHeader.getView() == child) {
                ...
                final SmartRefreshLayout.LayoutParams lp = (SmartRefreshLayout.LayoutParams) headerView.getLayoutParams();
            ...
            if (mRefreshFooter != null && mRefreshFooter.getView() == child) {
                ...
                final SmartRefreshLayout.LayoutParams lp = (SmartRefreshLayout.LayoutParams) footerView.getLayoutParams();
                final int widthSpec = ViewGroup.getChildMeasureSpec(widthMeasureSpec, lp.leftMargin + lp.rightMargin, lp.width);
            ...
            if (mRefreshContent != null && mRefreshContent.getView() == child) {
                ...
                final SmartRefreshLayout.LayoutParams lp = (SmartRefreshLayout.LayoutParams) contentView.getLayoutParams();
...
//            reboundAnimator.setDuration(20000);
    ...
    protected void animSpinnerBounce(final float velocity) {
        if (reboundAnimator == null) {
            if (velocity > 0 && (mState == RefreshState.Refreshing || mState == RefreshState.TwoLevel)) {
                animationRunnable = new SmartRefreshLayout.BounceRunnable(velocity, mHeaderHeight);
                ...
                animationRunnable = new SmartRefreshLayout.BounceRunnable(velocity, -mFooterHeight);
            } else if (mSpinner == 0 && mEnableOverScrollBounce) {
                animationRunnable = new SmartRefreshLayout.BounceRunnable(velocity, 0);
            }
        }
    }
    ...
    protected SmartRefreshLayout.LayoutParams generateDefaultLayoutParams() {
        return new SmartRefreshLayout.LayoutParams(MATCH_PARENT, MATCH_PARENT);
    }
    ...
    public SmartRefreshLayout.LayoutParams generateLayoutParams(AttributeSet attrs) {
        final View thisView = this;
        return new SmartRefreshLayout.LayoutParams(thisView.getContext(), attrs);
    }
...
//    }
    ...
    public SmartRefreshLayout setRefreshHeader(@NonNull RefreshHeader header, int width, int height) {
        ...
        if (mRefreshHeader.getSpinnerStyle() == SpinnerStyle.FixedBehind) {
            super.addView(mRefreshHeader.getView(), 0, new SmartRefreshLayout.LayoutParams(width, height));
        } else {
    ...
    public SmartRefreshLayout setRefreshFooter(@NonNull RefreshFooter footer, int width, int height) {
        ...
        if (mRefreshFooter.getSpinnerStyle() == SpinnerStyle.FixedBehind) {
            super.addView(mRefreshFooter.getView(), 0, new SmartRefreshLayout.LayoutParams(width, height));
        } else {
    ...
    public SmartRefreshLayout setRefreshContent(@NonNull View content, int width, int height) {
        ...
        super.addView(content, 0, new SmartRefreshLayout.LayoutParams(width, height));
        if (mRefreshHeader != null && mRefreshHeader.getSpinnerStyle() == SpinnerStyle.FixedBehind) {
